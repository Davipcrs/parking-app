...
class EditSubscriberView extends ConsumerStatefulWidget {
  final Subscriber subscriber;
  const EditSubscriberView({super.key, required this.subscriber});

  @override
  ConsumerState<EditSubscriberView> createState() => _EditSubscriberViewState();
}

class _EditSubscriberViewState extends ConsumerState<EditSubscriberView> {
  ...
  void initState() {
    ...
    formatedDateInit = widget.subscriber.str_initdate.toString();
    formatedDateEnd = widget.subscriber.str_enddate.toString();
    nameController.text = widget.subscriber.str_name.toString();
    licenseController.text = widget.subscriber.str_license.toString();
    celNumberController.text = widget.subscriber.str_contact.toString();
    carModelController.text = widget.subscriber.str_carmodel.toString();
    weekDaysController.text = widget.subscriber.str_weekdays.toString();
  }
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        setState(() {
                          ...
                          formatedDateEnd =
                              dateFormats(today.add(const Duration(days: 30)));
                        });
                      },
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        sub.id_mensalista = widget.subscriber.id_mensalista;
                        ...
                        ref
                            .read(apiPatchSubscriberProvider.notifier)
                            .patchSubscriber(sub);
